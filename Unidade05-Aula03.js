class Cliente{ // Definindo uma classe CLIENTE com as respectivas PROPRIEDADES da classe ...
    ...
    depositar(valor){ // Definindo um comportamento pra os métodos .depositar...
        this.saldo += valor
    }

    exibirSaldo(){ // Definindo um comportamento para os métodos .exibirSaldo...
        console.log(this.saldo)
    }
}

const andre = new Cliente("Andre", "andre@email.com", "78978978978", 100); // Definindo andre estamos criando uma INSTÂNCIA da classe CLIENTE para  o objeto ANDRE usando o construtor da classe...
console.log(andre);

andre.exibirSaldo(); // chamando a "função"...

// Construtor de CLASSE começam com Letra_maiúscula! Construtor recebe parâmetros...
