// 03 - PROPRIEDADES DE PROTOTYPES

// DESAFIO - Cliente Genérico - Gerar uma função que permita gerar novos clientes a partir de um modelo.
...
console.log(andre);
// Nova Instância new Função()

/*
03 - Propriedades de Prototype
PRÓXIMA ATIVIDADE
