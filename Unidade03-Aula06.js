...
console.log(jsonLivro)COPIAR CÓDIGO
O resultado é um string JSON:

{"id":50,"titulo":"Primeiros Passos com NodeJS","autor":"João Rubens","categoria":"programação","versoes":["ebook","impresso"]}COPIAR CÓDIGO
Para fazer o processo inverso:

const objLivro = JSON.parse(jsonLivro)
console.log(objLivro)COPIAR CÓDIGO
...
https://stackoverflow.com/questions/49875306/marshall-json-in-nodejs
*/